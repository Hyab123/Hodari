...
connection = create_connection("/Users/hyab/sql_tutorial/singoak8_pods.sqlite5")
...
VALUES
  ('Hyab','510.612.3737','member'),
  ('Milan','111.111.1111', 'member'),
  ('Maurice','(510) 435-2594','member'),
  ('Zyion','(415) 684-0505','member');
"""
